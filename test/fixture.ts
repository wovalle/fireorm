...
const getColFixture = () => {
  ...
  bands.push({
    ...
    albums:[
      {id: 'lightbulb-sun', name: 'Lightbulb Sun', releaseDate: new Date('2000-05-22')},
      {id: 'in-absentia', name: 'In Absentia', releaseDate: new Date('2002-09-24')},
      {id: 'deadwing', name: 'Deadwing', releaseDate: new Date('2005-03-25')},
      {id: 'fear-blank-planet', name: 'Fear of a Blank Planet', releaseDate: new Date('2007-04-16')},
    ]
  })
  ...
  bands.push({
    ...
    albums: [
      {id: 'dark-side-moon', name: 'The Dark Side of the Moon', releaseDate: new Date('1973-03-01')},
      {id: 'wish-you-were-here', name: 'Wish You Were Here', releaseDate: new Date('1975-09-12')},
  ...
  bands.push({
    ...
    albums: [
      {id: 'californication', name: 'Californication', releaseDate: new Date('1999-06-08')},
      {id: 'by-the-way', name: 'By the Way', releaseDate: new Date('2002-07-09')},
      {id: 'stadium-arcadium', name: 'Stadium Arcadium', releaseDate: new Date('2006-05-09')},
    ]
  })
